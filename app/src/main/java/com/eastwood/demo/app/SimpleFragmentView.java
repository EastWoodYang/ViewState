...
import com.eastwood.demo.app.base.BaseViewExtraFragment;

public class SimpleFragmentView extends BaseViewExtraFragment<SimpleFragmentViewState, SimpleFragmentController> {
    ...
    public void initContentView(View contentView) {
        ...
        getViewExtras().getTitleBar().setDefaultTitleBarStyle("Simple Fragment Title");
        ...
        contentView.findViewById(R.id.btn_finish).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getViewState().viewEvent.finishEvent.setValue(true);
            }
        });
    }
